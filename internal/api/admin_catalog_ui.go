...
<form id="searchForm" class="search-box"><input class="field" id="query" type="search" value="한강" minlength="1" maxlength="100" placeholder="책 제목, 저자, 출판사를 입력하세요" aria-label="도서 검색어" autocomplete="off"><button class="search-button" id="searchButton" type="submit">검색</button></form>
